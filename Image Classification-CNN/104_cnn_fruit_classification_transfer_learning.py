...
# Since last layer is max pooling layer, we need to flatten it.
...
def make_prediction(image):
    ...
    predicted_probs = class_probs[0][predicted_class]
...
for folder in folder_names:
    ...
    for image in images:
        ...
        predicted_label, predicted_probs = make_prediction(processed_image)
        
        actual_labels.append(folder)
        predicted_labels.append(predicted_label)
        predicted_probabilities.append(predicted_probs)
